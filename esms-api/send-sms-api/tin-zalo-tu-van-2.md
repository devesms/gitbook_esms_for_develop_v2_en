# Copy of Send Zalo Consulting message

This endpoint is used for sending the consulting message via Zalo.

It is ideal to send the message for advising the customers on products or services.
