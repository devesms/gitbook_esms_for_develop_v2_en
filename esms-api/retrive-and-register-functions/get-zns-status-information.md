...
| status         | int    | ZNS status.                                                                                                                                                                                                                                                    |

{% hint style="info" %}
Note: Request limit is 30 TPS.
{% endhint %}
